...
download.file("https://query1.finance.yahoo.com/v7/finance/download/%5EOMX?period1=1555616072&period2=1587238472&interval=1d&events=history",
              destfile = file.path(workdir, "data", "OMX30", "OMX30.csv"), method = "curl", extra = c("-L"), quiet = FALSE)

# Store relevant data
destfile <- file.path(workdir, "data", "OMX30", "OMX30.csv")
...
ggsave(filename = "OMX30.png", plot = p,
